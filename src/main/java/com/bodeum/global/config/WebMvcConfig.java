...
import com.bodeum.global.auth.AiTermsAgreedInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private final AiTermsAgreedInterceptor aiTermsAgreedInterceptor;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // @RequireAiTermsAgreed가 붙은 핸들러에서만 AI 이용동의를 검사한다.
        registry.addInterceptor(aiTermsAgreedInterceptor);
    }
}
