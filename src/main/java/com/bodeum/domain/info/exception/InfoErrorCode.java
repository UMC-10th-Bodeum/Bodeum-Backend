...
public enum InfoErrorCode implements BaseErrorCode {
    ...
    // 400 Bad Request
    INVALID_ID_FORMAT(HttpStatus.BAD_REQUEST, "INFO0400_2", "잘못된 요청입니다. 올바른 정보 식별자 형식이 아닙니다."),
    ...
    // 404 Not Found
    INFO_ITEM_NOT_FOUND(HttpStatus.NOT_FOUND, "INFO0404_1", "해당 리소스를 찾을 수 있어 공유 링크 생성이 불가능합니다."),
