...
public final class AiStarterQuestionCatalog {
    ...
    private static final List<AiStarterQuestion> QUESTIONS = List.of(
            ...
            new AiStarterQuestion(
                    ...
                    "우리 동네 재활센터 추천해줘",
                    "우리 동네 재활센터를 추천해줘",
                    "우리 동네 재활센터 알려줘", "우리 동네 재활센터를 알려줘",
                    "우리 지역 재활센터 추천해줘", "우리 지역 재활센터를 추천해줘",
                    "우리 지역 재활센터 알려줘", "우리 지역 재활센터를 알려줘",
                    "근처 재활센터 추천해줘", "근처 재활센터를 추천해줘",
                    "근처 재활센터 알려줘", "근처 재활센터를 알려줘",
                    "주변 재활센터 추천해줘", "주변 재활센터를 추천해줘",
                    "주변 재활센터 알려줘", "주변 재활센터를 알려줘",
                    "가까운 재활센터 추천해줘", "가까운 재활센터를 추천해줘",
                    "가까운 재활센터 알려줘", "가까운 재활센터를 알려줘"),
            new AiStarterQuestion(
            ...
            new AiStarterQuestion(
                    ...
                    "자폐 정보를 확인할 공식 웹사이트 추천해줘",
                    "자폐아 부모가 참고할 사이트가 있을까",
                    "자폐스펙트럼 관련 홈페이지 알려줘",
                    "자폐 관련 정보를 볼 수 있는 사이트 추천해줘")
    );
